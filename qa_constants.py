...
QA_SUBTYPE_LINE_EXTRACTION_WATERSHED = "le_subtype_watershed"
QA_SUBTYPE_LINE_EXTRACTION_EYNOLLAH = "le_subtype_eynollah"
QA_SUBTYPE_LINE_EXTRACTION_ALL = "le_subtype_all"
VALID_QA_LINE_EXTRACTION_SUBTYPES = [
    QA_SUBTYPE_LINE_EXTRACTION_WATERSHED,
    QA_SUBTYPE_LINE_EXTRACTION_EYNOLLAH,
    QA_SUBTYPE_LINE_EXTRACTION_ALL
]
